...
int				start_uns_char_conv(t_flags *fl, unsigned char data, char c,
						const char *s);
int				start_uns_short_conv(t_flags *fl, unsigned short int data,
						char c, const char *s);
int				start_uns_long_conv(t_flags *fl, unsigned long int data,
						char c, const char *s);
int				start_uns_long_long_conv(t_flags *fl,
						unsigned long long int data, char c, const char *s);
...
int				ft_conversion_ll_i_d(t_flags *fl, long long int nb,
						const char *s);
int				ft_conversion_b(t_flags *fl, unsigned int nb, const char *s);
int				ft_conversion_h_b(t_flags *fl, unsigned short int nb,
						const char *s);
int				ft_conversion_hh_b(t_flags *fl, unsigned char nb,
						const char *s);
int				ft_conversion_l_b(t_flags *fl, unsigned long int nb,
						const char *s);
int				ft_conversion_ll_b(t_flags *fl, unsigned long long int nb,
						const char *s);
int				ft_conversion_o(t_flags *fl, unsigned int nb, const char *s);
int				ft_conversion_h_o(t_flags *fl, unsigned short int nb,
						const char *s);
int				ft_conversion_hh_o(t_flags *fl, unsigned char nb,
						const char *s);
int				ft_conversion_l_o(t_flags *fl, unsigned long int nb,
						const char *s);
int				ft_conversion_ll_o(t_flags *fl, unsigned long long int nb,
						const char *s);
int				ft_conversion_u(t_flags *fl, unsigned int nb, const char *s);
int				ft_conversion_h_u(t_flags *fl, unsigned short int nb,
						const char *s);
int				ft_conversion_hh_u(t_flags *fl, unsigned char nb,
						const char *s);
int				ft_conversion_l_u(t_flags *fl, unsigned long int nb,
						const char *s);
int				ft_conversion_ll_u(t_flags *fl, unsigned long long int nb,
						const char *s);
int				ft_conversion_xmin(t_flags *fl, uintptr_t nb, const char *s);
int				ft_conversion_h_xmin(t_flags *fl, unsigned short int nb,
						const char *s);
int				ft_conversion_hh_xmin(t_flags *fl, unsigned char nb,
						const char *s);
int				ft_conversion_l_xmin(t_flags *fl, unsigned long int nb,
						const char *s);
...
int				ft_conversion_h_xmaj(t_flags *fl, unsigned short int nb,
						const char *s);
int				ft_conversion_hh_xmaj(t_flags *fl, unsigned char nb,
						const char *s);
int				ft_conversion_l_xmaj(t_flags *fl, unsigned long int nb,
						const char *s);
int				ft_conversion_ll_xmaj(t_flags *fl, unsigned long long int nb,
						const char *s);
int				ft_conversion_f(t_flags *fl, double nb, const char *s);
int				ft_conversion_lmaj_f(t_flags *fl, long double nb,
						const char *s);
...
int				ft_pad_diouxxb_right(t_flags *fl, const char *conv,
						const char *s, const char c);
int				ft_pad_diouxxb_left(t_flags *fl, const char *conv,
						const char *s, const char c);
int				ft_pad_diouxxb(t_flags *fl, const char *conv,
						const char *s, const char c);
int				ft_pad_f(t_flags *fl, const char *conv, const char *s,
						int precis);
