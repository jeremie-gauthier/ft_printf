...
//   ft_printf("%d\n", ft_printf("4.1caractere 1 %12c caractere 2 %12c\n", 'a', 'c'));
//   printf("%d\n\n", printf("4.1caractere 1 %12c caractere 2 %12c\n\n", 'a', 'c'));

//   ft_printf("%d\n", ft_printf("4.2caractere 1 %-12c caractere 2 %-12c\n", 'a', 'c'));
//   printf("%d\n\n", printf("4.2caractere 1 %-12c caractere 2 %-12c\n\n", 'a', 'c'));
